...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    header("location: http://localhost/css2/ex2/login");
    exit;
}
...
<div class="nav nav-black">
    <div class="nav nav-red">
      <div class="nav nav-white">
        ...
        <img
          src="https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fphoto.16pic.com%2F00%2F01%2F29%2F16pic_129006_b.jpg&refer=http%3A%2F%2Fphoto.16pic.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1671845959&t=50a5a9635603f6e1feb3169133f50c74"
          alt="Logo" class="logo">
...
<div class="wrapper">
	...
	<a href="http://localhost/ex2/logout" class="button3">Sign Out of Your Account</a>
